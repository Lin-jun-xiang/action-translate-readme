...
>>>>>>> e8d59d9653b0f607b111bcd7b3efc8aae56059be
> 方法:
>
...
使用vscode最大的理由就是要有一個`搶眼`、`優雅`、`舒適`、`愉快的編輯界面`. 只有好看的編輯環境才能讓coder們願意敲鍵盤~ :表情符號_太陽鏡:
...
* 如果找不到這個主題，<a href="https://marketplace.visualstudio.com/items?itemName=Levampire.Buttur" target="_blank">link</a >
